...
\\ \textit{- HEC-RAS, TUFLOW, OpenFOAM (turbulence modeling), HEC-HMS, MODFLOW, WMS/GMS}

\textbf{Geospatial Analysis}
\\ \textit{- ArcGIS, QGIS, ArcPy, GDAL, shapely, geopandas, Google Earth}

\textbf{Statistics \& Probability}
\\ \textit{- Regression models, machine learning, statistical tests, probabilistic models, time series analysis, signal processing}
